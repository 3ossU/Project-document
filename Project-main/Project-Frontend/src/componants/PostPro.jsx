  ...
  return (
    <Container>
      ...
      <FormCard>
        ...
        <Label>อัพโหลดรูปภาพอสังหาริมทรัพย์ <span style={{ color: 'red' }}>*</span></Label>
        <UploadArea
        ...
        <Label>ชื่ออสังหา <span style={{ color: 'red' }}>*</span></Label>
        <Input
        ...
        <Label>ประเภทอสังหา <span style={{ color: 'red' }}>*</span></Label>
        <Select
          value={propertyType}
        ...
        <Label>ขายหรือเช่า <span style={{ color: 'red' }}>*</span></Label>
        <Select
          value={saleType}
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        <FormCard>
          <Label>ราคาอสังหา (สำหรับขาย) {saleType === 'ขาย' && <span style={{ color: 'red' }}>*</span>}</Label>
          <Input
            type="number"
            placeholder="ใส่ราคา"
            value={priceSale}
          ...
          <Label>ราคาอสังหา (สำหรับเช่า) {saleType === 'เช่า' && <span style={{ color: 'red' }}>*</span>}</Label>
          <Input
            type="number"
            placeholder="ใส่ราคา"
            value={priceRent}
