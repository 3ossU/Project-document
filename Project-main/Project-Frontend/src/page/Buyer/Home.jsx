...
const ScrollArrow = styled.button`
  ...
  ${props => props.$dir === 'left' ? 'left: -20px;' : 'right: -20px;'}
`;
...
const ScrollableCardRow = ({ children }) => {
  const ref = useRef(null);
  const scroll = (dir) => ref.current?.scrollBy({ left: dir * 320, behavior: 'smooth' });
  return (
    <ScrollableWrapper>
      <ScrollArrow $dir="left" onClick={() => scroll(-1)}>‹</ScrollArrow>
      <CardGrid ref={ref}>{children}</CardGrid>
      <ScrollArrow $dir="right" onClick={() => scroll(1)}>›</ScrollArrow>
    </ScrollableWrapper>
  );
};
  ...
  return (
    <PageWrapper>
      ...
      <Section>
        ...
        <ScrollableCardRow>
          <PropertyGrid properties={villaProperties} />
        </ScrollableCardRow>
      </Section>
      ...
      <Section>
        ...
        <ScrollableCardRow>
          <PropertyGrid properties={townhouseProperties} />
        </ScrollableCardRow>
      </Section>
    </PageWrapper>
  );
