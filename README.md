# SALA - Minimalist E-Commerce Clothing Platform By 67172467 surawat 


ยินดีต้อนรับสู่โปรเจกต์ **SALA** แพลตฟอร์ม E-Commerce ขายเสื้อผ้าออนไลน์ ที่เน้นประสบการณ์การใช้งานที่เรียบง่าย รวดเร็ว และมีระบบดูแลลูกค้าที่ครบวงจร พัฒนาขึ้นโดยผสมผสานเทคโนโลยีสมัยใหม่เพื่อรองรับการขยายตัวในอนาคต
...
2. **ปัญหาฝั่งแอดมิน:** ขาดเครื่องมือในการจัดการร้านค้าแบบจุดเดียว การเพิ่ม/ลดสินค้า ปรับเปลี่ยนหมวดหมู่เสื้อผ้า หรือจัดการข้อมูลของลูกค้าทำได้ยากและไม่เป็นระบบ
...
1. เพื่อพัฒนาเว็บไซต์ E-Commerce แบรนด์เสื้อผ้า SALA ที่ใช้งานง่าย 
2. เพื่อสร้างระบบการซื้อขาย ตะกร้าสินค้า และประวัติการสั่งซื้อที่มีประสิทธิภาพ ปลอดภัย และโปร่งใส
3. เพื่อพัฒนาระบบ Customer Support ในรูปแบบ Ticket ที่เชื่อมต่อระหว่างลูกค้าและเจ้าหน้าที่ได้อย่างไร้รอยต่อ // อาจทำทีหลัง
4. เพื่อสร้าง Dashboard หลังบ้านที่ช่วยให้ผู้ดูแลระบบบริหารจัดการสินค้า หมวดหมู่ และข้อมูลลูกค้าได้ในที่เดียว



##  5. ผู้ใช้งาน  และ User Requirements

ระบบนี้แบ่งผู้ใช้งานออกเป็น 3 กลุ่มหลัก โดยมีสิทธิ์และความต้องการในระบบดังนี้:

### 1. Customer (ลูกค้า)
* **สมัครบัญชีและเข้าสู่ระบบ** สามารถสมัครสมาชิกและเข้าสู่ระบบเพื่อใช้งานฟังก์ชันต่าง ๆ ได้
* **ค้นหาสินค้า ** สามารถค้นหาเสื้อผ้าที่ต้องการได้อย่างสะดวกรวดเร็ว
* **เพิ่มสินค้าลงตะกร้า (Add to Cart):** เลือกไซส์/สีของเสื้อผ้าที่ชอบแล้วกดเก็บไว้ในตะกร้าได้
* **สั่งซื้อสินค้า** ดำเนินการสั่งซื้อ ตรวจสอบยอดเงิน และชำระเงินตามขั้นตอน
* **ประวัติคำสั่งซื้อ** สามารถเรียกดูประวัติการสั่งซื้อเสื้อผ้าย้อนหลังของตนเองได้
* **ยื่น Ticket Support:** สามารถส่งคำร้องขอความช่วยเหลือ ติดต่อ Support หรือแจ้งปัญหาเกี่ยวกับออเดอร์ได้อย่างเป็นระบบ // อาจทำทีหลัง

### 2. Admin (ผู้ดูแลระบบ)
* **เพิ่มสินค้า:** เพิ่มเสื้อผ้ารุ่นใหม่ ๆ เข้าสู่ระบบร้านค้า
* **ลบสินค้า:** ลบสินค้าที่เลิกผลิตหรือไม่ได้ขายแล้วออกจากระบบ
* **แก้ไขสินค้า** อัปเดตราคา รายละเอียด รูปภาพ หรือจำนวนสต็อกสินค้า
* **เพิ่มหมวดหมู่สินค้า** สร้างและจัดการหมวดหมู่เสื้อผ้า (เช่น เสื้อยืด, กางเกง, เดรส)
* **จัดการข้อมูลลูกค้า** ดูและบริหารจัดการข้อมูลโปรไฟล์หรือบัญชีของลูกค้า
* **ตารางสถิติ** ดูสรุปสถิติต่าง ๆ ยอดขาย สินค้าคงเหลือ และภาพรวมของร้านค้า
* **ระบบติดตามสถานะคำสั่งซื้อ** ติดตามสถานะการสั่งซื้อสำหรีบ admin
* **ตอบ Ticket ลูกค้า:** เข้าไปดูคำร้อง/ข้อร้องเรียนที่ลูกค้าส่งเข้ามา และพิมพ์ตอบกลับเพื่อช่วยเหลือหรือแก้ไขปัญหาให้ลูกค้า // อาจทำทีหลัง


### 3. Support (เจ้าหน้าที่ดูแลลูกค้า)//อาจเพิ่มในภายหลัง
### 4. superadmin (แอดมินใหญ่)//อาจเพิ่มในภายหลัง
...
* ระบบตรวจสอบสิทธิ์ (Sign-up, Log-in, Password Hashing)
* ระบบแสดงผลสินค้า กรองหมวดหมู่ และค้นหาคำสำคัญ
* ระบบคำนวณราคาสินค้าในตะกร้าและตัดสต็อกเมื่อชำระเงิน
* หน้าต่างสำหรับแอดมินในการทำ CRUD (Create, Read, Update, Delete) สินค้า/หมวดหมู่/ลูกค้า และแสดงกราฟสรุปยอด
* ระบบการติดตาม สถานะคำสั่งซื้อของแอดมิน
* หน้าจอเฉพาะสำหรับ Support เพื่อดึงข้อมูล Ticket ที่ค้างอยู่มาตอบปฏิสัมพันธ์ // อาจทำทีหลัง
* *ระบบจัดเก็บและดึงข้อมูลประวัติการซื้อ รวมถึงระบบออกตั๋วแจ้งปัญหา // อาจทำทีหลัง

### 2. Non-Functional Requirements
* **ความเสถียร:** หน้าเว็บหน้าร้านต้องแสดงผลและโหลดข้อมูลเสร็จสิ้นภายใน 2 วินาที
* **ความปลอดภัย:** ป้องกันข้อมูลส่วนตัวของลูกค้าและรหัสผ่านด้วยการเข้ารหัสที่รัดกุม (เช่น bcrypt, HTTPS) ข้อมูลทางการเงินต้องปลอดภัย
* **การใช้งาน:** หน้าดีไซน์ต้องมินิมอล สบายตา และใช้งานง่าย ทั้งบนมือถือและคอมพิวเตอร์
...
* **Tickets** ระบบเก็บประวัติตั๋วขอความช่วยเหลือ (id, user_id, order_id [null if general], subject, message, status [open, pending, closed], created_at) // อาจทำทีหลัง
* **Ticket_Replies** ข้อความตอบกลับสำหรับพิมพ์คุยกันระหว่างลูกค้าและซัพพอร์ต (id, ticket_id, user_id, message, created_at) // อาจทำทีหลัง



##  8. เทคโนโลยีที่ใช้ (TechStack)
